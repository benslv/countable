module.exports = {
	name: "set-emoji",
	description: "Sets the reaction used by the bot when a user sends a count with not message.",
	args: true,
	guildOnly: true,
	ownerOnly: true,
	usage: "<emote ID>",
	execute(message, args) {
		...
		if (guildEmojis.has(args[0])) {
			...
			message.channel.send(`The emoji reaction has been updated and set to ${emoji}`);
		} else {
